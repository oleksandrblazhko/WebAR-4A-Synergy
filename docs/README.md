...
## Опис проекту
WebAR-додаток для відображення 3D-контенту, зображень та відео за допомогою AR-маркeрів.
...
```json
{
  ...
  "markers": [
    // ... конфігурація маркерів
  ]
}
```

## Налаштування привітального тексту
Додано можливість налаштовувати привітальний текст, який відображається перед входом у WebAR-додаток.

### Приклад налаштування:
```json
{
  "settings": {
    "welcomeText": "Press here<br>to enter the WebAR-booklet<br>Anastasia's English School"
  },
  "markers": [
    // ... конфігурація маркерів
  ]
